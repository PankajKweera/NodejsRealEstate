...
const getall = async (req, res) => {
  try {
    const data = await Land.find({ status: "verified" })
    console.log(data);
    res.json(data);
  } catch (error) {
...
//   try {
//     const { title, location, area, price, description, imageUrl, ownerId } =
//       req.body;
//     const land = new Land({
//       title,
//       location,
...
module.exports = { getall, getbylocation };
// getall, getbylocation, register, update, remove, verifyland, getunverified, getalluser, getallland, verifyland, getunverified, getalluser, getallland,
